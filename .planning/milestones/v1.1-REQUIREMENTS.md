# Requirements Archive: v1.1 Partial Deposits and Multi-Attempt Payments
...
**Adjusted:** CARD-02 — sandbox test card amounts corrected from SISP '100000' format to WooCommerce '100' format during gap closure
